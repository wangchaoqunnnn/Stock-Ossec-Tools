...
.trend-fill.up { background: linear-gradient(90deg, #ef4444, #f87171); }
.trend-fill.down { background: linear-gradient(90deg, #22c55e, #4ade80); }
...
.detail-tabs {
  background: linear-gradient(180deg, #141824, #1a1f2e);
